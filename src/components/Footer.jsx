...
const Footer = () => {
    const handleEmailClick = () => {
        window.location.href = 'mailto:bouazizimohamedaziz76@gmail.com';
    };
        ...
        <footer className="footer footer-center p-10  bg-base-200 text-base-content rounded">
            <aside>
                ...
                <p className="font-bold">
                    This website is for demonstration purposes only. No products listed are for sale.
                </p>
                <p>If you like the product you can contact me through the links below</p>
            </aside>
            <nav>
                <div className="grid grid-flow-col gap-4">
                    <div className="tooltip tooltip-bottom" data-tip="Github Link">
                        <a href="https://github.com/Aziz798" className='text-4xl'><FaGithub /></a>
                    </div>
                    <div className="tooltip tooltip-bottom" data-tip="Linkdin Link">
                        <a href="https://www.linkedin.com/in/mohamed-aziz-bouazizi-874998287/" className='text-4xl'><FaLinkedin /></a>
                    </div>
                    <div className="tooltip tooltip-bottom" data-tip="bouazizimohamedaziz76@gmail.com">
                        <button
